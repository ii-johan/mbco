// src/data/enneagramData.ts 파일 맨 위
...
export interface EnneagramQuestion {
  ...
  scoring: {
    ...
    // polarity 속성 추가 및 주석 해제: 답변 점수를 긍정적으로 반영할지(positive) 부정적으로 반영할지(negative)
    polarity: 'positive' | 'negative'; // 이 줄의 주석을 제거하고 활성화합니다.
...
// ... (이후 enneagramQuestions 배열 코드는 그대로 유지) ...
  {
    id: 1,
