...
export const enneagramQuestions: EnneagramQuestion[] = [
  {
    ...
    text_ko: "내가 특별하다는 확신이 있을 때 안정된다.", 
     // 개성주의자
    scoring: [{ type: 4 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
  ...
  }, 
  {
   id: 2,  
    text_ko: "지시받는 걸 몹시 싫어한다." ,
         // 도전주의자
    scoring: [{ type: 8 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
    id: 3, 
    text_ko: "누군가 나에게 의지하면 기분이 좋아진다." ,
     // 이타주의자
    scoring: [{ type: 2 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
    id: 4, 
  ...
  },
  {
    ...
    text_ko: "우울한 감정은 회피하고 싶어진다." ,
     // 낙천주의자
    scoring: [{ type: 7 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
    id: 6, 
  ...
  },
  {
    ...
    text_ko: "나는 권위를 인정하면서도 거북한 감정이 동시에 존재한다." ,
     // 충성주의자
    scoring: [{ type: 6 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
   id: 8, 
    text_ko: "정보를 많이 모을수록 안정감을 느낀다.",
     // 탐구주의자
    scoring: [{ type: 5 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
   id: 9, 
    text_ko: "내 의견보다는 주변 분위기를 따른다.",
     // 평화주의자
    scoring: [{ type: 9 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
   id: 10, 
    text_ko: "결과가 좋으면 과정은 중요하지 않다고 생각한다.",
     // 성취주의자
    scoring: [{ type: 3 }] // 기본적으로 type만 지정하면 1-7점 척도를 그대로 반영할 수 있습니다.
                           // 또는 { type: 1, weight: 1, polarity: 'positive' } 와 같이 명시적으로 표현 가능
  },
  {
   id: 11, 
